...
<script>(function(d, s, id) {
 ...
 <!-- Fixed navbar -->
	...
	<header id="head">
		<div class="container">
			<div class="row">
				<h1 class="lead">Welcome to Courserator</h1>
				<p class="tagline">Courserator: A platform for constructive course discussions </p>
				<p><a class="btn btn-default btn-lg" href="./login.php" role="button">Login</a> <a class="btn btn-action btn-lg" href="./register.php" role="button">Register</a></p>
			</div>
		</div>
	</header>
